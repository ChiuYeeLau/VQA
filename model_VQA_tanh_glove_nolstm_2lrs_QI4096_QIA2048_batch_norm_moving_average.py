...
class Answer_Generator():
    ...
    def build_model(self, is_training):
        ...
        # 500 * 26 * 300
        inputs = tf.reduce_sum(tf.tanh(input[:,:25,:] + inputs[:,1:,:]), 1)
    ...
    def build_generator(self, is_training):
        ...
        QIA_BN = tf.contrib.layers.batch_norm(QIA, decay=self.decay, is_training = is_training, scope = 'QIA_BN', resue = True)
