...
class Answer_Generator():
    ...
    def build_model(self):
        ...
        QI = compact_bilinear_pooling_layer(Q_emb_4d, image_emb_4d, self.QI_dim)
        ...
        QI_emb_3d = tf.expand_dims(QI_emb, 1)
        QI_emb_4d = tf.expand_dims(QI_emb_3d, 2)

        QIA = compact_bilinear_pooling_layer(QI_emb_4d, A_emb_4d, self.QIA_dim)
