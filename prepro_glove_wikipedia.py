...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_json', default='data_prepro_wikiGlove.json', help='output json file')
    parser.add_argument('--output_h5', default='data_prepro_wikiGlove.h5', help='output h5 file')
